...
def track():
    ...
    api_url = "https://api.tracktry.com/v1/trackings/get?page=1&limit=2000"
    print("API HITTTTT")
...
def trackpage2():
    ...
    api_url = "https://api.tracktry.com/v1/trackings/get?page=2&limit=2000"
    print("API HITTTTT")
    # headers =  {"Content-Type":"application/json","Tracktry-Api-Key":"27654af3-b244-4192-b7d8-ce32be8d86c4"}
    headers =  {"Content-Type":"application/json","Tracktry-Api-Key":"ae2e8060-296c-4423-a980-c9e166e51498"}
...
def tracpage3k():
    ...
    api_url = "https://api.tracktry.com/v1/trackings/get?page=3&limit=2000"
    print("API HITTTTT")
    # headers =  {"Content-Type":"application/json","Tracktry-Api-Key":"27654af3-b244-4192-b7d8-ce32be8d86c4"}
    headers =  {"Content-Type":"application/json","Tracktry-Api-Key":"ae2e8060-296c-4423-a980-c9e166e51498"}
...
class GetDetails(ListAPIView):
    queryset = Tracker.objects.all().values()
    # print(queryset,'dict')
...
#         instance = Tracker.objects.all().values()
#         # print(instance)
...
class NewData(APIView):
    def get(self,request):
        user_list = Tracker.objects.all().order_by('-api_call_time')[:4].values('tracking_number','api_call_time')
        ind_time = datetime.now(timezone("Asia/Kolkata")).strftime('%H:%M:')
        # if ind_time < ind_time + timedelta(hours=3):
        now = datetime.now()  # get the current datetime
        thr =  ind_time + timedelta(hours=3)
        # print(now)
        print(thr)
        # if now < thr:    
        #     print('HI')
